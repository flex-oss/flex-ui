...
/**
 * References all available icons inside bootstrap's glyphicon icon sprite.
 *
 * @see <a href="http://getbootstrap.com/components/#glyphicons">http://getbootstrap.com/components/#glyphicons</a>
 * @author mostly copied from de.agilecoders/wicket-bootstrap
 */
public final class GlyphIconType extends IconType {
    ...
    public static final GlyphIconType IMPORT = new GlyphIconType("import");
    ...
    public static final GlyphIconType SOUND = new GlyphIconType("sound-");
    ...
    public String toString() {
        return "GlyphIconType[\"" + getCssClassName() + "\"]";
    }
}
